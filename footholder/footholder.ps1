function Check-Domain {
    Write-Host "`n========== [ Checking current domain ] ================================================================================================================`n" -ForegroundColor Yellow
    Write-Host "Domain: " $env:USERDNSDOMAIN
}

function Check-DomainLogonServers {
    Write-Host "`n========== [ Checking domain logon servers ] =========================================================================================================`n" -ForegroundColor Yellow
    $dc = $env:LOGONSERVER -replace "\\", ""
    Write-Host "Domain Controller for Logon: " $dc
}

function Check-OS-Information {
    Write-Host "`n========== [ System Information Overview ] ============================================================================================================`n" -ForegroundColor Yellow
...
function Check-AntivirusStatus {
    Write-Host "`n========== [ Checking Antivirus Status ] ============================================================================================================`n" -ForegroundColor Yellow
...
function Check-WhoAmI {
    Write-Host "`n========== [ Checking who you are ] ===================================================================================================================`n" -ForegroundColor Yellow
    whoami /all
}
...
function Check-LocalAdmin {
    Write-Host "`n========== [ Checking if you're a local admin ] =======================================================================================================`n" -ForegroundColor Yellow
    $whoibe = $env:Username
    $currentUser  = whoami
...
function Check-LocalAdmins {
    Write-Host "`n========== [ Checking Local Admins ] ==================================================================================================================`n" -ForegroundColor Yellow
...
function Check-NetworkAdapters {
    Write-Host "`n========== [ Checking Network Adapters ] ==============================================================================================================`n" -ForegroundColor Yellow
    ...
    # Print header
    Write-Host "`n========== [ Network Configuration ] ===================================================================================================================`n" -ForegroundColor Yellow
...
function Check-OpenPorts_Services {
    Write-Host "`n========== [ Enumerating Open Ports and Services ] ====================================================================================================`n" -ForegroundColor Yellow
...
function Check-PowerShellHistory {
    Write-Host "`n========== [ Checking PowerShell history ] ============================================================================================================`n" -ForegroundColor Yellow
...
function Check-C-Drive {
    Write-Host "`n========== [ Listing All Folders in C:\ ] ============================================================================================================`n" -ForegroundColor Yellow
...
function Check-SharedDrives {
    Write-Host "`n========== [ Checking for shared drives ] =============================================================================================================`n" -ForegroundColor Yellow
...
function Check-AppLockerPolicies {
    Write-Host "`n========== [ Checking for Applocker Policies ] ========================================================================================================`n" -ForegroundColor Yellow
    Get-AppLockerPolicy -Effective | Format-List
}

function Check-InstalledSoftware {
    Write-Host "`n========== [ Installed Software Gathered from Windows Registry ] ======================================================================================`n" -ForegroundColor Yellow
...
function Check-ProgramFiles {
    Write-Host "`n========== [ List of Subfolders in Program Files ] ====================================================================================================`n" -ForegroundColor Yellow
...
function Check-UnquotedServicePaths {
    Write-Host "`n========== [ Checking for Unquoted Service Paths ] ====================================================================================================`n" -ForegroundColor Yellow
...
function Check-AlwaysInstallElevated {
    Write-Host "`n========== [ Checking for AlwaysInstallElevated Vulnerability ] =======================================================================================`n"  -ForegroundColor Yellow
    $vulnerable = $false
...
function Check-InterestingFiles {
    Write-Host "`n========== [ Checking for interesting files in C:\Users ] =============================================================================================`n" -ForegroundColor Yellow
...
function Check-SSHDirectories {
    Write-Host "`n========== [ Checking for .ssh directories ] ==========================================================================================================`n" -ForegroundColor Yellow
...
function Check-Flags {
    Write-Host "`n========== [ Checking for flags ] =====================================================================================================================`n" -ForegroundColor Yellow
    $flagFiles = Get-ChildItem -Path "C:\" -Recurse -File -ErrorAction SilentlyContinue | Where-Object { $_.Name -in "proof.txt", "local.txt", "secret.txt" }
...
function Check-OtherInterestingFiles {
    Write-Host "`n========== [ Checking for other interesting files in disk ] ===========================================================================================`n" -ForegroundColor Yellow
...
function Get-DomainGroups {
    Write-Host "`n========== [ Listing Domain Groups ] =================================================================================================================`n" -ForegroundColor Yellow
...
function Get-DomainUsers {
    Write-Host "`n========== [ Listing Domain Users ] =================================================================================================================`n" -ForegroundColor Yellow
...
function Get-DomainEmailAddresses {
    Write-Host "`n========== [ Generating Domain Email Addresses ] =================================================================================================================`n" -ForegroundColor Yellow
...
function Get-DomainGroupMembers {
    Write-Host "`n========== [ Retrieving Domain Group Members ] =====================================================================================================`n" -ForegroundColor Yellow
